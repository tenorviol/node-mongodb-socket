...
function bsonObject() {
  var bson_raw = consume.call(this, 4);
  var bson_len = BinaryParser.toInt(bson_raw);
  bson_raw += consume.call(this, bson_len - 4);
...
function decodeReply() {
  this._message.flags          = BinaryParser.toInt(consume.call(this, 4));
  this._message.cursorID       = BinaryParser.toLong(consume.call(this, 8));
  this._message.startingFrom   = BinaryParser.toInt(consume.call(this, 4));
  this._message.numberReturned = BinaryParser.toInt(consume.call(this, 4));
  this._message.documents      = bsonObject.call(this);
}

function decodeQuery() {
  this._message.flags          = BinaryParser.toInt(consume.call(this, 4));
  this._message.collection     = cstring.call(this);
  this._message.numberToSkip   = BinaryParser.toInt(consume.call(this, 4));
  this._message.numberToReturn = BinaryParser.toInt(consume.call(this, 4));
  this._message.query          = bsonObject.call(this);
}
